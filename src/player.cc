...
void Player::check_for_level_up() {
  vector<int> levels = {
//   1     2      3      4       5       6       7       8       9
    2000, 3000, 4000, 6000, 8000, 12000, 16000, 24000, 30000,
//   10       11     12      13       14       15       16
     50000, 65000, 95000, 130000, 190000, 255000, 410000,
//   17       18       19
     500000, 750000, 1050000,

//   20        21        22        23         24         25
     2100000, 4200000, 8400000, 16800000, 33600000, 67200000,
//   26         27         28         29
     134400000, 268800000, 537600000, 1075200000
  };
