...
static Ring::Type random_ring_type() {
  ...
  switch (Game::current_level) {
    ...
    case 50: potential_rings.push_back(Ring::Speed); [[clang::fallthrough]];
    case 45:
    case 46:
    case 47:
    case 48:
    ...
    case 32:
    case 33:
    case 34: potential_rings.push_back(Ring::Strength); [[clang::fallthrough]];
    case 25:
    case 26:
    case 27:
    case 28:
    ...
    case 2:
    case 3:
    case 4: potential_rings.push_back(Ring::Adornment);
  }
...
Ring::Ring(std::istream& data) { load(data); }

Ring::Ring(Ring::Type type) : Item(), subtype{type}, identified{false} {
  o_type = IO::Ring;
  o_which = type;
  ...
  switch (type) {
    ...
    case Ring::Accuracy: {
      switch (os_rand_range(100)) {
        ...
        case 3:
        case 4: set_armor(-17); break;
        case 5:
        case 6: set_armor(-16); break;
        case 7:
        case 8: set_armor(-15); break;
        case 9:
        case 10: set_armor(-14); break;
        case 11:
        case 12: set_armor(-13); break;
        case 13:
        case 14: set_armor(-12); break;
        case 15:
        case 16: set_armor(-11); break;
        case 17:
        case 18: set_armor(-10); break;
        case 19:
        case 20: set_armor(-9); break;
        case 21:
        case 22: set_armor(-7); break;
        case 23:
        case 24:
        case 25: set_armor(-6); break;
        case 26:
        case 27:
        case 28: set_armor(-5); break;
        case 29:
        case 30:
        case 31: set_armor(-4); break;
        case 32:
        case 33:
        case 34: set_armor(-3); break;
        case 35:
        case 36:
        case 37:
        case 38: set_armor(-2); break;
        case 39:
        case 40:
        case 41:
        case 42:
        case 43:
        case 44: set_armor(-1); break;
        case 45:
        case 46:
        case 47:
        case 48:
        case 49:
        case 50:
        case 51: set_armor(1); break;
        case 52:
        case 53:
        case 54:
        case 55:
        case 56:
        case 57: set_armor(2); break;
        case 58:
        case 59:
        case 60:
        case 61: set_armor(3); break;
        case 62:
        case 63:
        case 64:
        case 65: set_armor(4); break;
        case 66:
        case 67:
        case 68:
        case 69: set_armor(5); break;
        case 70:
        case 71:
        case 72: set_armor(6); break;
        case 73:
        case 74:
        case 75: set_armor(7); break;
        case 76:
        case 77:
        case 78: set_armor(8); break;
        case 79:
        case 80:
        case 81: set_armor(9); break;
        case 82:
        case 83:
        case 84: set_armor(10); break;
        case 85:
        case 86: set_armor(11); break;
        case 87:
        case 88: set_armor(12); break;
        case 89:
        case 90: set_armor(13); break;
        case 91:
        case 92: set_armor(15); break;
        case 93:
        case 94: set_armor(16); break;
        case 95:
        case 96: set_armor(17); break;
    ...
    case Ring::Adornment:
    case Ring::Searching:
    case Ring::SlowDigestation:
    case Ring::Regeneration:
    case Ring::Stealth:
    case Ring::SeeInvisible:
    case Ring::SustainStrenght:
    case Ring::Speed: {
      break;
    }
...
bool Ring::is_magic() const { return true; }
...
void Ring::init_rings() {
  ...
  vector<string> stones{
      "agate",          "alexandrite",  "amethyst",  "carnelian", "diamond",
      "emerald",        "germanium",    "granite",   "garnet",    "jade",
      "kryptonite",     "lapis lazuli", "moonstone", "obsidian",  "onyx",
      "opal",           "pearl",        "peridot",   "ruby",      "sapphire",
      "stibotantalite", "tiger eye",    "topaz",     "turquoise", "taaffeite",
      "zircon"};

  while (materials->size() < static_cast<size_t>(Ring::Type::NRINGS)) {
    size_t const stone{static_cast<size_t>(os_rand_range(stones.size()))};

    if (find(materials->begin(), materials->end(), stones.at(stone)) !=
        materials->end())
      continue;
...
std::string Ring::get_description() const {
  ...
  os << "a" << vowelstr(materials->at(subtype)) << " " << materials->at(subtype)
     << " ring";
...
bool Ring::is_identified() const { return identified; }
...
int Ring::get_base_value() const { return worth(subtype); }
...
bool Ring::is_stackable() const { return true; }
bool Ring::autopickup() const { return option_autopickup(o_type); }
