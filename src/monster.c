...
struct monster monsters[26] =
{
  ...
  { "aquator",       0, ISMEAN,               { 10,  20,  5,  18,   1, {{0,1}},              0 } },
  { "bat",           0, ISFLY,                { 10,   1,  1,  17,   1, {{1,2}},              0 } },
  { "centaur",      15, 0,                    { 10,  17,  4,  16,   1, {{1,2},{1,5},{1,5}},  0 } },
  { "dragon",      100, ISMEAN,               { 10,5000, 10,  21,   1, {{1,8},{1,8},{3,10}}, 0 } },
  { "emu",           0, ISMEAN,               { 10,   2,  1,  13,   1, {{1,2}},              0 } },
  { "venus flytrap", 0, ISMEAN,               { 10,  80,  8,  17,   1, {{0,1}},              0 } },
  { "griffin",      20, ISMEAN|ISFLY|ISREGEN, { 10,2000, 13,  18,   1, {{4,3},{3,5}},        0 } },
  { "hobgoblin",     0, ISMEAN,               { 10,   3,  1,  15,   1, {{1,8}},              0 } },
  { "ice monster",   0, 0,                    { 10,   5,  1,  11,   1, {{0,1}},              0 } },
  { "jabberwock",   70, 0,                    { 10,3000, 15,  14,   1, {{2,12},{2,4}},       0 } },
  { "kestrel",       0, ISMEAN|ISFLY,         { 10,   1,  1,  13,   1, {{1,4}},              0 } },
  { "leprechaun",    0, 0,                    { 10,  10,  3,  12,   1, {{1,1}},              0 } },
  { "medusa",       40, ISMEAN,               { 10, 200,  8,  18,   1, {{3,4},{3,4},{2,5}},  0 } },
  { "nymph",       100, 0,                    { 10,  37,  3,  11,   1, {{0,1}},              0 } },
  { "orc",          15, ISGREED,              { 10,   5,  1,  14,   1, {{1,8}},              0 } },
  { "phantom",       0, ISINVIS,              { 10, 120,  8,  17,   1, {{4,4}},              0 } },
  { "quagga",        0, ISMEAN,               { 10,  15,  3,  17,   1, {{1,5},{1,5}},        0 } },
  { "rattlesnake",   0, ISMEAN,               { 10,   9,  2,  17,   1, {{1,6}},              0 } },
  { "snake",         0, ISMEAN,               { 10,   2,  1,  15,   1, {{1,3}},              0 } },
  { "troll",        50, ISREGEN|ISMEAN,       { 10, 120,  6,  16,   1, {{1,8},{1,8},{2,6}},  0 } },
  { "black unicorn", 0, ISMEAN,               { 10, 190,  7,  22,   1, {{1,9},{1,9},{2,9}},  0 } },
  { "vampire",      20, ISREGEN|ISMEAN,       { 10, 350,  8,  19,   1, {{1,10}},             0 } },
  { "wraith",        0, 0,                    { 10,  55,  5,  16,   1, {{1,6}},              0 } },
  { "xeroc",        30, 0,                    { 10, 100,  7,  13,   1, {{4,4}},              0 } },
  { "yeti",         30, 0,                    { 10,  50,  4,  14,   1, {{1,6},{1,6}},        0 } },
  { "zombie",        0, ISMEAN,               { 10,   6,  2,  12,   1, {{1,8}},              0 } },
};
